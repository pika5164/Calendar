#R Final Project
#The user can:
#1.Making the schedule by her/himself.
#2.Input a date shows the date detail
#ex. input:Month:5 output:calender in May
#ex. input:1996-12-01 output:Happy Birthday!
